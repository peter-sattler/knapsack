 ...
 */
public final class KnapsackSmartImpl extends KnapsackBaseImpl implements Serializable {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(KnapsackSmartImpl.class);
     ...
     */
    public KnapsackSmartImpl(BigDecimal capacity) {
